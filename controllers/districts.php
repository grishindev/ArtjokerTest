...
if (isset($_POST['city_ter_id']) && !empty($_POST['city_ter_id'])) {
    ...
    echo "<option value='0' selected disabled>Район города / ПГТ / Село / Деревня</option>";
    ...
    echo "<select class='form-control district' name='district' disabled><option>Район города / ПГТ / Село / Деревня</option></select>";
}
